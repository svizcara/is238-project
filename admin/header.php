<?php 
/**
 *  Displays the header of the helpdesk admin dashboard
 */
include '../config.php';
...
if (!isset($_SESSION['user'])) {
    ...
    if ( $_SESSION['user']['user_type'] != 'admin' ) {
        $_SESSION['msg'] = '<div class="alert alert-warning fixed-top" role="alert">You must log as admin to access this page</div>';
        exit(header('location: ../index.php'));
    }
}
...
<html>
    <head>
        ...
        <title>Helpdesk A | Admin dashboard </title>
